        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
				...
				"ajaxEmail":{
					...
					"alertTextOk":"* Email liberado para utiliza&ccedil;&atilde;o",	
					"alertTextLoad":"* Validando email, aguarde...",
					"alertText":"* Este email j&aacute; foi cadastrado, por favor informe outro."}
            };
