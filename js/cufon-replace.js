Cufon.replace('header nav #liCadastrar, header nav #liEntrar', { fontFamily: 'Myriad Pro Regular', textShadow: '#000 1px 1px', hover:true });
//Cufon.replace('.link2', { fontFamily: 'Myriad Pro Regular', textShadow: '#265800 1px 1px', hover:{textShadow: 'none'} });
Cufon.replace('h1, .span1', { fontFamily: 'Myriad Pro Regular', textShadow: '#000 1px 1px', color: '-linear-gradient(#82b704, #699303)' });
Cufon.replace('h1 span, .span2', { fontFamily: 'Myriad Pro Regular', color: '-linear-gradient(#fff, #cdcdcd)' });
